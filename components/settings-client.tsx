    ...
    <div className="space-y-6 max-w-xl">
      ...
      <form onSubmit={handleSave} className="glass-panel p-6 rounded-2xl space-y-6">
        ...
        <div className="flex gap-3 pt-4 border-t border-white/5">
          ...
          <button
            type="submit"
            className="flex-1 flex items-center justify-center gap-2 rounded-xl bg-emerald-500 hover:bg-emerald-600 px-4 py-2.5 text-xs font-bold text-white shadow-lg shadow-emerald-500/10 transition-all cursor-pointer"
          >
